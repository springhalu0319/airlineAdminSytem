...
<head>
    ...
    <![endif]-->
    <title>民航管理系统</title>
    <meta name="keywords" content="airline reservation system">
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            <dt><i class="Hui-iconfont">&#xe616;</i> <a data-href="picture-list.html" data-title="图片管理" href="javascript:void(0)">系统主页</a></dt>
        </dl>
        <dl id="menu-picture">
            <dt><i class="Hui-iconfont">&#xe613;</i> 订票客户</dt>
        </dl>
        <dl id="menu-product">
            <dt><i class="Hui-iconfont">&#xe620;</i> 航班机票</dt>
        ...
        <dl id="menu-tongji">
            <dt><i class="Hui-iconfont">&#xe61a;</i> 权限管理</dt>
